			...
			<div <?php echo( ! empty( $cssID ) ? 'id="' . $cssID . '"' : '' ); ?> class="rpwe-block">
				...
				<ul class="rpwe-ul">
					...
					<?php foreach ( $rpwewidget as $post ) : setup_postdata( $post ); ?>
						...
						<li <?php post_class('rpwe-clearfix rpwe blog-entry'); ?> >
...
<img src="<?php echo aq_resize( wp_get_attachment_url( get_post_thumbnail_id() ),  wpex_img( 'blog_width' ), wpex_img( 'blog_height' ), wpex_img( 'blog_crop' ) ); ?>" alt="<?php echo the_title(); ?>" />
							...
							<div class="entry-text clearfix">
								<div class="title"><h2><a class="rpwe-title" href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'rpwe' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">
								<?php the_title(); ?>
								</a></h2></div>
							<ul class="entry-meta">
							
							by <?php the_author_posts_link(); ?><div class="cat"><?php the_category('');?></div></ul><!-- /entry-meta -->
...
function rpwe_custom_styles() {
	?>
<style>
.rpwe-block ul{list-style:none!important;margin-left:0!important;padding-left:0!important;}.rpwe-block li{margin-bottom:20px;padding-bottom:10px;list-style-type: none;}.rpwe-block a{display:inline!important;text-decoration:none;}.rpwe-block h3{clear:none; margin: 17px 20px 20px;font-weight:400; line-height:1.5em;}.rpwe-thumb{padding-right:20px!important;}.rpwe-summary{font-size:12px;}.rpwe-time{color:#bbb;font-size:11px;}.rpwe-alignleft{display:inline;float:left;}.rpwe-alignright{display:inline;float:right;}.rpwe-alignnone{display:block;float:none;}.rpwe-clearfix:before,.rpwe-clearfix:after{content:"";display:table !important;}.rpwe-clearfix:after{clear:both;}.rpwe-clearfix{zoom:1;}
</style>
	<?php
}